...
import Chart10 from '@/components/chart/Chart10.vue'
import Chart11 from '@/components/chart/Chart11.vue'
import Chart12 from '@/components/chart/Chart12.vue'
import Chart13 from '@/components/chart/Chart13.vue'
import Chart14 from '@/components/chart/Chart14.vue'
export default {
  name: 'Home',
  data(){
    return{
...
<style lang="scss">
@import "../../src/shared/helper";
%legend {
  height: px(40); display: flex; align-items: center;
